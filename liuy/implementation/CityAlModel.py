...
from liuy.implementation.RandomSampler import CityRandomSampler
import numpy as np
import random
...
if __name__ == "__main__":
    ...
    seg_model = CitySegModel(args=args, project_id='RandomModel', data_dir=data_dir)
    data_loader = seg_model.trainer.data_loader
    randomsampler = CityRandomSampler('randomsampler', data_loader)
