...
from liuy.implementation.CoresetSamplerV3 import CoreSetSampler
import numpy as np
import random
...
if __name__ == "__main__":
    ...
    coresetsampler = CoreSetSampler('coreset_sampler', project_id=project_id, whole_image_id_list=copy.deepcopy(whole_image_id))
    generate_one_curve(
