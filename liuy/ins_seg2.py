...
from liuy.interface import BaseDeepModel
...
class InsSegModel(BaseDeepModel):
    """Mask_RCNN"""
    ...
    def predict_proba(self, conf_thres=0.7, nms_thres=0.4,
                      verbose=True, **kwargs):
        """
...
if __name__ == "__main__":
    ...
    model = InsSegModel(args=args, project_id='ins_seg2', data_dir=data_dir)
    model.fit_on_subset()
    model.test()
    debug = 1
